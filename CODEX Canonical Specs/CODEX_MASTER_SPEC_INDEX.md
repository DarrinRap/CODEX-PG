...
| `RELAY_SPEC_v0.2.md` | Codex canonical | PG Core Relay module | Role-aware Relay hub, duplicate detection/resolution, message templates, Dropbox receipts, tester/developer views, BUGS.md capture, status updates, and settings contract. |
